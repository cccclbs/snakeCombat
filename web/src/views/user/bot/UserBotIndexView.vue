...
export default {
    ...
    setup() {
        ...
        const refresh_bots = () => {
            $.ajax({
                url: "http://101.33.236.23:3000/api/user/bot/getlist/",
                type: "get",
                headers: {
        ...
        const add_bot = () => {
            ...
            $.ajax({
                url: "http://101.33.236.23:3000/api/user/bot/add/",
                type: "post",
                data: {
                    title: botadd.title,
        ...
        const update_bot = (bot) => {
            botadd.error_message = "";
            $.ajax({
                url: "http://101.33.236.23:3000/api/user/bot/update/",
                type: "post",
                data: {
                    bot_id: bot.id,
                    title: bot.title,
        ...
        const remove_bot = (bot) => {
            $.ajax({
                url: "http://101.33.236.23:3000/api/user/bot/remove/",
                type: "post",
                data: {
                    bot_id: bot.id,
                },
